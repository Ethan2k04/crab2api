  ...
  <div class="card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        ...
        <router-link to="/dashboard/usage" class="flex items-center justify-center gap-2 py-3 text-sm font-medium text-primary-600 transition-colors hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
