          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              <div class="py-1">
                ...
                <!--
                  The upstream repository link was removed with the Crab2API
                  rebrand: it pointed admins at Wei-Shaw/sub2api, which is not
                  this product. Version/update checking still uses that repo
                  internally (see VersionBadge.vue).
                -->
