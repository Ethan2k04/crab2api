<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      <span class="hidden whitespace-nowrap sm:inline">{{ currentLocale?.name }}</span>
      <Icon
        name="chevronDown"
        size="xs"
    ...
    <transition name="dropdown">
      ...
      >
        <button
          ...
          class="flex w-full items-center gap-2 whitespace-nowrap px-3 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-dark-700"
          :class="{
