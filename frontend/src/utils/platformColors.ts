 ...
 *
 * `anthropic` is painted in the `primary` scale (Claude clay, #c15f3c) rather
 * than Tailwind's stock `orange` (#f97316). Every plan on this site is an
 * Anthropic plan, so the platform colour *is* the brand colour — using the
 * generic orange made the console's plan cards and CTAs a noticeably brighter,
 * more saturated orange than the same buttons on the landing page and the
 * header. The other platforms keep their stock hues; they are there to tell
 * upstreams apart, not to carry the brand.
 */
...
const BADGE: Record<Platform, string> = {
  anthropic: 'bg-primary-500/10 text-primary-600 border-primary-500/30 dark:text-primary-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  anthropic: 'bg-primary-500/15 text-primary-700 dark:bg-primary-500/15 dark:text-primary-300',
...
const BORDER: Record<Platform, string> = {
  anthropic: 'border-primary-500/20 dark:border-primary-500/25',
...
const BORDER_STRONG: Record<Platform, string> = {
  anthropic: 'border-primary-500/35 dark:border-primary-500/35',
...
const ACCENT: Record<Platform, string> = {
  anthropic: '#c15f3c', // primary-500 (Claude clay)
...
const ACCENT_DEFAULT = '#c15f3c' // primary-500 (Claude clay)

// ── Accent bar (gradient) ───────────────────────────────────────────
const ACCENT_BAR: Record<Platform, string> = {
  anthropic: 'bg-gradient-to-r from-primary-400 to-primary-500',
...
const TEXT: Record<Platform, string> = {
  anthropic: 'text-primary-600 dark:text-primary-400',
...
const ICON: Record<Platform, string> = {
  anthropic: 'text-primary-500 dark:text-primary-400',
...
const DISCOUNT: Record<Platform, string> = {
  anthropic: 'bg-primary-100 text-primary-700 dark:bg-primary-900/50 dark:text-primary-300',
...
const GRADIENT: Record<Platform, string> = {
  anthropic: 'from-primary-500 to-primary-600',
