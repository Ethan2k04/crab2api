              ...
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.defaults.defaultUserRequestLimit5h") }}
                  </label>
                  <input
                    v-model.number="form.default_user_request_limit_5h"
                    type="number"
                    min="0"
                    step="1"
                    class="input"
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultUserRequestLimit5hHint") }}
                  </p>
                </div>
              </div>
...
const form = reactive<SettingsForm>({
  ...
  default_user_request_limit_5h: 30,
  site_name: "Crab2API",
  site_logo: "",
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      default_user_request_limit_5h: form.default_user_request_limit_5h,
...
.settings-tab::before {
  ...
  content: "";
  background: linear-gradient(135deg, rgb(250 249 247 / 0.95), rgb(244 243 238 / 0.8));
}
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, #c15f3c, #d18060);
}
...
.dark .settings-tabs-shell {
  border-color: rgb(62 60 55 / 0.75);
  background: rgb(32 31 29 / 0.88);
  box-shadow:
...
.dark .settings-tab::before {
  background: linear-gradient(135deg, rgb(43 42 39 / 0.9), rgb(62 60 55 / 0.62));
}
