...
type User struct {
	...
	// RequestAlertPct5h holds the value of the "request_alert_pct_5h" field.
	RequestAlertPct5h int `json:"request_alert_pct_5h,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldRequestLimit5h, user.FieldRequestAlertPct5h:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldRequestAlertPct5h:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field request_alert_pct_5h", values[i])
			} else if value.Valid {
				_m.RequestAlertPct5h = int(value.Int64)
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("request_alert_pct_5h=")
	builder.WriteString(fmt.Sprintf("%v", _m.RequestAlertPct5h))
	builder.WriteByte(')')
