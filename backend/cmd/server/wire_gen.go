...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userWindow5hCache := repository.NewUserWindow5hCache(redisClient)
	...
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userWindow5hCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository)
	...
	rateWindowService := service.NewRateWindowService(userRepository, userWindow5hCache)
	usageHandler := handler.NewUsageHandler(usageService, apiKeyService, opsService, settingService, rateWindowService)
